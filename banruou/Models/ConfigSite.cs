...
namespace banruou.Models
{
    public class ConfigSite
    {
        ...
        [StringLength(500, ErrorMessage = "Tối đa 500 ký tự"), Display(Name = "Đường dẫn Zalo"),
        Url(ErrorMessage = "Đường dẫn không chính xác"), UIHint("TextBox")]
        ...
        [Display(Name = "Địa chỉ 1"), StringLength(500, ErrorMessage = "Tối đa 50 ký tự"), UIHint("TextBox")]
